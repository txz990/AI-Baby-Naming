...
import { Copy, Heart, Loader2, ChevronDown } from "lucide-react";
...
export default function NamingGenerator() {
  ...
  const toggleSection = (section: "basic" | "preference" | "advanced") => {
    ...
    <div className="min-h-screen bg-background py-6 md:py-12">
      <div className="container">
        ...
        <div className="mb-6 md:mb-8">
          <h1 className="text-2xl md:text-4xl font-bold text-foreground mb-2">为宝宝取名</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-1 space-y-3 md:space-y-4">
            ...
            <div className="bg-card rounded-xl border border-border overflow-hidden">
              ...
              >
                <h3 className="font-semibold text-foreground">基础信息</h3>
            ...
            {/* Naming Preference Section */}
            <div className="bg-card rounded-xl border border-border overflow-hidden">
              <button
                onClick={() => toggleSection("preference")}
                className="w-full px-6 py-4 flex items-center justify-between hover:bg-muted/50 transition-colors"
              >
                <h3 className="font-semibold text-foreground">取名偏好</h3>
                <ChevronDown className={`w-5 h-5 transition-transform ${expandedSections.preference ? "rotate-180" : ""}`} />
              </button>
            ...
            <div className="bg-card rounded-xl border border-border overflow-hidden">
              <button
                ...
                className="w-full px-6 py-4 flex items-center justify-between hover:bg-muted/50 transition-colors"
              >
                <h3 className="font-semibold text-foreground">高级选项</h3>
                  ...
                  <div>
                    ...
                    <Select value={formData.radical} onValueChange={(value) => handleInputChange("radical", value)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="earth">土</SelectItem>
                        <SelectItem value="metal">金</SelectItem>
                        <SelectItem value="grass">草字头</SelectItem>
                        <SelectItem value="female">女字旁</SelectItem>
                        <SelectItem value="roof">宝盖头</SelectItem>
                        <SelectItem value="person">单人旁</SelectItem>
                        <SelectItem value="double_person">双人旁</SelectItem>
                        <SelectItem value="none">不限</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
            ...
            <div className="bg-card rounded-xl border border-border p-6">
              <h3 className="font-semibold text-foreground mb-4">生成设置</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                  {generatedNames.map((name) => (
                    <div key={name.id} className="bg-card rounded-xl border border-border p-4 md:p-6 hover:border-primary/50 transition-colors">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          <h4 className="text-2xl md:text-3xl font-bold text-primary mb-1">{name.fullName}</h4>
                      ...
                      {name.source && (
                        <div className="mb-3">
                          <p className="text-xs font-semibold text-foreground mb-1">出处</p>
                          <p className="text-xs md:text-sm text-muted-foreground">{name.source}</p>
                        </div>
                      )}
                      ...
                      {name.soundAnalysis && (
                        <div className="mb-4">
                          <p className="text-xs font-semibold text-foreground mb-1">音韵分析</p>
                          <p className="text-xs md:text-sm text-muted-foreground">{name.soundAnalysis}</p>
                        </div>
                      )}
